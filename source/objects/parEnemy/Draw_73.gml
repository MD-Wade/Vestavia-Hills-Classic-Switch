...
if (g.settingEnemyHealthbars)   {
    if (statsHealth < statsHealthMax)   {
        if (stateCurrent != ESTATES.Dead)    {
            ...
            draw_set_alpha(0.8);
            draw_healthbar(drawHealthbar_x1, drawHealthbar_y1, drawHealthbar_x2, drawHealthbar_y2, (statsHealth / statsHealthMax) * 100, c_black, _drawColour, _drawColour, 0, true, true);
            draw_set_alpha(1);
        }
    }
}
