/// @description GoreExecuteKillNonLethal(direction);
/// @param direction
function GoreExecuteKillNonLethal() {
	//Oh.
	...
	GoreExecuteSound(_soundIndex, _soundPitch, _soundGain, _soundDistance, true);
